      ...
      <div className="z-10 flex justify-between items-center h-full max-w-[1800px] mx-auto">
          ...
          {currentSong && (
            <>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-sm text-gray-300 truncate hover:underline cursor-pointer">
                  {currentSong.artist}
                </div>
              </div>
            </>
        ...
        <div className="flex flex-col items-center gap-2 flex-1 max-w-full sm:max-w-[45%]">
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <Button
              size="icon"
              className="bg-gradient-to-r from-purple-400 to-pink-500 hover:scale-125 text-white rounded-full h-8 w-8 cursor-pointer"
              onClick={togglePlay}
              disabled={!currentSong}
            >
              {isPlaying ? (
